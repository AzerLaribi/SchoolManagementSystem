...
<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Exercices</h6><a class="btn btn-primary float-right" href="/AjouterExercices" role="button" target="_blank">Ajouter Exercice</a>
                        </div>
                        <div class="card-body">
                          @if (session('status'))
