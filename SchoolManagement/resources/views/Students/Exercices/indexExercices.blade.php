                                    ...
                                    <tbody>
                                      ...
                                      @if($exercice->Matiere_id == $matiere->id && $exercice->Classe_id == $classe->id && (\Carbon\Carbon::parse (\Carbon\Carbon::now()) <= (\Carbon\Carbon::parse ($exercice->deadline))))
                                        <tr style="text-align : center">
                                          ...
                                          <td>{{ \Carbon\Carbon::parse (\Carbon\Carbon::now())->diffInDays(\Carbon\Carbon::parse ($exercice->deadline))}} Jours</td>
                                          <td>
                                            <div class="row" style="display : flex; justify-content:center;">
                                              <a href=""
                                               class="btn btn-primary btn-circle mr-1" target="_blank">
                                                <i class="fas fa-download"></i>
                                              </a>
                                              <button type="button" class="btn btn-success btn-circle mr-1" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i></button>
                                              </div>
                                            </td>
                                        </tr>
                                        @endif
